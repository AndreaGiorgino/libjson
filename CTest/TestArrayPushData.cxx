...
auto TestArrayPushData(int, char**) -> int {
    ...
    helpers::check_child_eq(el0, 0, expected);

    // null initialised
    json el1 {};
    el1.push_back(expected);
    helpers::check_child_eq(el1, 0, expected);
    ...
    helpers::check_child_eq(el2, 0, expected);
    ...
    helpers::check_child_eq(el3, 0, 69);
    helpers::check_child_eq(el3, 1, expected);
